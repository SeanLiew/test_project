...
<body>
	<div class="cont">
		<div class="txt">
			...
			<p>
				<span>特别提醒：在您确认接受本合同之前，请您务必仔细阅读本合同所有条款，特别是以粗体或下划线标注的条款。一旦您通过网络页面点击确认或以其他方式选择接受本合同，即意味着您已充分理解本合同所有条款的含义及相应的法律后果，同意与本合同其他方以数据电文形式订立本合同并接受本合同约束。</span>
			</p>
			...
			<h4>鉴于：</h4>
			<p>1、甲方和乙方均为联银财富APP注册用户；</p>
			<p>2、 鉴于前期乙方有意向甲方借款，且甲方有意向乙方出借款项。经协商一致，各方达成如下内容，以资共同信守：</p>

			<h4>第一条  释义</h4>
			<p>1.1本合同：指本《借款协议》以及甲方和乙方在北京联银信息技术有限公司（以下简称联银公司）运营的联银财富APP注册账户、乙方在申请借款过程中同意的所有条款；</p>
			<p>1.2合同成立时间:指文首合同签订之日；</p>
			<p>1.3合同生效时间:指出借人通过联银公司的联银财富APP向借款人正式发放借款的时间；</p>
			<p>1.4合同有效期间:指出借人向借款人发放借款，至借款人偿还所有的本金和利息的期间；</p>
			<p>1.5期间:所有的期间均包括起止日期的当天；</p>
			<p>1.6数字:所有数字均包括本数；</p>
			<p>1.7个人信息：指可用于识别或用户身份和信用的信息，包括但不限于身份证信息、组织机构代码证、统一社会信用代码、电话联系方式、联银财富APP账户注册信息、地理位置和电子通讯录等；</p>
			<p>1.8联银财富APP平台：指由北京联银信息技术有限公司（以下简称“联银公司”）旗下运营管理的互联网金融信息中介服务APP软件，致力于为平台注册用户提供居间融资及管理服务。</p>
			<p>1.9绑定账户：指出借人或借款人以自身名义在联银财富APP平台注册后系统自动产生的宜宾市商业银行存管虚拟电子账户，可以通过宜宾市商业银行、第三方支付机构及/或其他通道进行充值或提现。</p>

			<h4>第二条  借款信息及借款流程</h4>
			<p>
				2.1甲方有权通过联银公司向乙方收取利息费，利息费计算开始时间为您通过联银财富APP平台成功申请“POS贷”功能并通过联银财富APP账号绑定的指定银行存管账号或联银财富APP账号余额收到借款时起算，您已支付的分期利息费一经收取将不予退还。
				甲乙双方均同意并认可，甲方可通过在联银财富APP平台绑定的银行存管账户或第三方支付账户中将出借款项划付至乙方指定账户中。出借款项划转至乙方指定账户后，即视为乙方已经收到该笔借款款项。
			</p>
			<p>
			 	2.2乙方同意通过联银财富APP平台从甲方借入以下款项，，同时甲方同意通过趣生财APP向乙方出借如下款项： 
			 	<table>
			      <thead>
			      <tr>
			        <th>姓名</th>
